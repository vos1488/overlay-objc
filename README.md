...
- 📱 **Компактный режим** - минимальная информация в одной строке
- ⚙️ Настройки через графический интерфейс
- 💾 Автоматическое сохранение настроек

## Режимы отображения

### Полный режим (по умолчанию)
Отображает всю доступную информацию в виде подробного списка в левой части экрана.

### Компактный режим  
Минимальная информация в одной строке в верхней части экрана:
- Время
- Заряд батареи (🔋xx%)
- Использование памяти (💾x.xGB)
- Нагрузка CPU (⚡xx%)
...
1. Оверлей появится поверх всех окон
2. Оверлей игнорирует щелчки мыши, кроме кнопок управления
3. Для выхода нажмите кнопку закрытия (✕) в правом верхнем углу
4. Нажмите кнопку настроек (⚙) для доступа к настройкам

### Переключение режимов

- В настройках можно переключаться между полным и компактным режимами
- Настройки автоматически сохраняются при изменении
- При следующем запуске приложение использует сохраненные настройки
